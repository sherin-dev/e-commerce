...
const aboutList = [
   { imgUrl: '/src/assets/images/about/icon/01.jpg', imgAlt: 'about icon rajibraj91 rajibraj', title: 'Skilled Instructors', desc: 'Distinctively provide acces mutfuncto users whereas communicate leveraged services', }, 
          ...
          <div className="col">
            <div className='about-left'>
              <div className="about-thumb">
                <img src="/src/assets/images/about/01.jpg" alt="" srcset="" />
              </div>                          
