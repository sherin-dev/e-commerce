...
const contactList = [ 
  { imgUrl: "/src/assets/images/icon/01.png", imgAlt: "contact icon", title: "Office Address", desc: "Palayam, Thambanoor", }, 
        ...
        <div className="container">
          ...
          <div className='section-wrapper'>
            <form className='contact-form'> 
              ...
              <div className="form-group">
                <input type="number" name='number' id='mobnnumber' placeholder='Mobile Number*' />
              </div>
              <div className="form-group">
